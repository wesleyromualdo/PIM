jQuery(document).ready(function ()
{
	...
	{ 
		location.href='exemplo.php?modulo=exemplo/controle/pessoa/cadastrar';
	});
	
	jQuery('.ibox-footer .limpar').click(function ()
	{ 
		location.href='exemplo.php?modulo=exemplo/controle/pessoa/listar';
	});
...
{
	location.href='?modulo=exemplo/controle/pessoa/cadastrar&petid=' + petid;
}
...
function removerPessoa(petid)
{
    ...
    {
        if (isConfirm) {
        	location.href='?modulo=exemplo/controle/pessoa/listar&requisicao=apagarPessoa&petid=' + petid;
        }
    });	
}