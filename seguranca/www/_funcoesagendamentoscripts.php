...
function inserirAgendamentoScripts($dados) {
	...
	$sql = "INSERT INTO seguranca.agendamentoscripts(
            agsfile, agsperiodicidade, agsperdetalhes, agsstatus, agsdescricao)
    		VALUES ('".$dados['agsfile']."', '".$dados['agsperiodicidade']."', ".(($dados['agsperdetalhes'])?"'".implode(";",$dados['agsperdetalhes'])."'":"NULL").", 'A', ".(($dados['agsdescricao'])?"'".$dados['agsdescricao']."'":"NULL").");";
...
function atualizarAgendamentoScripts($dados) {
	...
	$sql = "UPDATE seguranca.agendamentoscripts
	   		SET agsfile='".$dados['agsfile']."', 
	   			agsperiodicidade='".$dados['agsperiodicidade']."', 
	   			agsperdetalhes=".(($dados['agsperdetalhes'])?"'".implode(";",$dados['agsperdetalhes'])."'":"NULL").",
	   			agsdescricao=".(($dados['agsdescricao'])?"'".$dados['agsdescricao']."'":"NULL")."
