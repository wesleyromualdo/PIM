 ...
 * @version $Id: BasicWS.php 101880 2015-08-31 19:50:33Z maykelbraz $
 */
...
abstract class Simec_BasicWS
{
    ...
    /**
     * @var SoapClient Referência para o client do webservice.
     */
    private $soapClient;
...
PHP;
    ...
    final public function getWSDLFunctions()
    {
        ...
        foreach($functions as $func) {
            ...
            if ($temp[0] == 'void') {
                $code .=  $nl . "        \$this->getSoapClient()->call('$func', array({$p1}));{$nl}    }{$nl}";
            } else {
                $code .= '        return ' .  "\$this->getSoapClient()->call('$func', array({$p1}));{$nl}    }{$nl}";
            }
        }
        return $code;
    }
