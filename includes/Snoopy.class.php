...
class Snoopy
{
	...
	/* user definable vars */
	var $host			=	null;	// host name we are connecting to
	var $port			=	null;				// port we are connecting to
	var $proxy_host		=	null;				// proxy host to use
	var $proxy_port		=	null;				// proxy port to use
	var $proxy_user		=	null;				// proxy user to use
	var $proxy_pass		=	null;				// proxy password to use
	var $agent			=	"Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1)";	// agent we masquerade as
	var	$referer		=	"http://simec.mec.gov.br";	// referer info to pass
	...
	var $read_timeout	=	90;					// timeout on read operations, in seconds
	...
	var $_httpversion	=	"HTTP/1.1";			// default http request version
