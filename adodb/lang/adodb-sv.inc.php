...
$ADODB_LANG_ARRAY = array (
            ...
            DB_ERROR_CANNOT_DROP        => 'kan inte slÃ¤ppa',
            DB_ERROR_CONSTRAINT         => 'begrÃ¤nsning krÃ¤nkt',
            ...
            DB_ERROR_NOSUCHFIELD        => 'inget sÃ¥dant fÃ¤lt',
            DB_ERROR_NOSUCHTABLE        => 'ingen sÃ¥dan tabell',
            DB_ERROR_NOT_CAPABLE        => 'DB backend klarar det inte',
            DB_ERROR_NOT_FOUND          => 'finns inte',
            DB_ERROR_NOT_LOCKED         => 'inte lÃ¥st',
            DB_ERROR_SYNTAX             => 'syntaxfel',
            DB_ERROR_UNSUPPORTED        => 'stÃ¶ds ej',
            DB_ERROR_VALUE_COUNT_ON_ROW => 'vÃ¤rde rÃ¤knat pÃ¥ rad',
            DB_ERROR_INVALID_DSN        => 'ogiltig DSN',
            DB_ERROR_CONNECT_FAILED     => 'anslutning misslyckades',
            0	                       => 'inget fel', // DB_OK
            DB_ERROR_NEED_MORE_DATA     => 'otillrÃ¤ckligt med data angivet',
            DB_ERROR_EXTENSION_NOT_FOUND=> 'utÃ¶kning hittades ej',
            DB_ERROR_NOSUCHDB           => 'ingen sÃ¥dan databas',
            DB_ERROR_ACCESS_VIOLATION   => 'otillrÃ¤ckliga rÃ¤ttigheter'
);
