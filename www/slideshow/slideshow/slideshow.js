...
var SlideShow = new Class({
	...
	initialize: function(container, images, options){
		...
		this.image = document.getElementById("fotoinicio").value;
		this.imageLoaded = 0;
		this.stopped = true;
		this.started = false;
		this.paused = true;
		this.animating = false;
		this.descricao = new Array();
	},
	
	load: function(){
		$clear(this.timer);
		this.loading.setStyle('display','block');
		document.getElementById("descricaoimagem").innerHTML = this.descricao[this.image];
		this.image++;
