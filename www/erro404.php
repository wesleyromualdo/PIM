                        ...
                        <div class="middle-box text-center animated fadeInDown">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="glyphicon glyphicon-lock"></span> ERRO 404 (Página não encontrada)
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="error-desc">
                                        <div class="error-desc">
                                            <p>Desculpe, 
                                                mas a página que você está procurando não foi encontrada,
                                                clique em voltar para retornar à página inicial.</p>
