		...
		switch($extensao) {
			...
			case 'jpeg':
				try {
					...
					echo "<script>alert(\"JPG com problemas. Abra o o arquivo em algum visualizador local e resalve a imagem, em seguida execute o procedimento de upload novamente.\");</script>";
					return false;
