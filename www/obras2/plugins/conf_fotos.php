...
$funcao = ((empty($_REQUEST['funcao'])) ? "?funcao=AtualizaFotos" : "");
$abas = array(0 => array("id"		=>"1",
						 "descricao"=>"Avançado",
						 "link"		=>"/obras/plugins/component_foto.php".($funcao)),
			  1 => array("id"		=>"2",
			  			 "descricao"=>"Básico",
			  			 "link"		=>"/obras/plugins/component_foto_simples.php".($funcao))
			  );
