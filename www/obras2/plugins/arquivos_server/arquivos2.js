...
$(function () {
	...
	var uploader = new qq.FileUploader({
	    ...
	    personalAddToList: function(id, fileName, item){
								...
								$('.itemListaDiv:contains(' + fileName + ')').each(function(k, elem){
							    	//faz verificaÃ§Ã£o para pegar itens IGUAIS e nÃ£o que CONTENHAM
							    	//lÃ³gica para evitar pegar a linha de um arquivo com o nome semelhante
	...
	// lÃ³gica para remover a classe de seleÃ§Ã£o quando clicar para navegar nas pastas ou fazer download
...
function adicionaMenuDireito(){
    ...
    //quando clicado com o botÃ£o direito, seleciona o elemento
...
function createLine(item){
	...
	tagImg.src = './css/dropbox-icons/' + item.attr.icon + '.gif';
...
//funÃ§Ã£o para transformar uma linha de upload em uma linha de download
...
//FunÃ§Ã£o para exibir div de carregamento
//status on|off
//elem Elemento onde a div serÃ¡ carregada
