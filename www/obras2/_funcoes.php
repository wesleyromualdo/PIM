...
//              $habil   = 'N';
    ...
    if ($_POST['not(listaObras)'] != true) {
        echo "<listaObras> <div class='table-responsive'>";
        if ($sgeid) {
            $grupoEmpresa = new Supervisao_Grupo_Empresa();
...
//            if ($obrasPendentes) {
        ...
        if ($obrasPendentes) {
            $avisoPendencia = '
                        <div class="row container-geral warning">
                            <div class="col">
                                Senhor Prefeito/Secretário,<br>
        ...
        $htm = "<div class=\"row\">
                    ...
                    <div class=\"container-geral\">
                        <div class=\"row\">
                            <b>Tipo de ensino:</b> {$dados['orgdesc']}
                        </div>
                    </tr>";
...
function cadastrarSupervisaoPorOS($sosid)
{
    ...
    if ($arrEmpid) {
        ...
        /**
         * @TODO
         * Comentado envio de email de OS pois a biblioteca do DOMPDF esta dando erro
         **/
//        $email = new Email();
...
function montaBarraFerramentasTooltip($obrid)
{
    ...
    $html = '
            <div class="row container-geral" id="barra-ferramenta-obra">
                <div class="col">
                    ' . $butonsLeft . '' . $butons . '
                </div>
            </div>
