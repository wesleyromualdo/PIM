	...
	*/
	...
	function saveData()
	{
		...
		document.formulario.colunas.value = saveString;
		formulario.submit();
	...
	function escondeColuna(id){
		var colid = id;
		document.getElementById('conteudo_id_' + colid).style.display = "none";
		document.getElementById('mais_coluna_' + colid).style.display = "";
		document.getElementById('menos_coluna_' + colid).style.display = "none";
		document.getElementById('coluna_id_' + colid).style.height = "45px";
		document.getElementById('estado_coluna_' + colid).value = "minimizada";
	}
	function exibeColuna(id){
		var colid = id;
		document.getElementById('conteudo_id_' + colid).style.display = "";
		document.getElementById('mais_coluna_' + colid).style.display = "none";
		document.getElementById('menos_coluna_' + colid).style.display = "";
		document.getElementById('coluna_id_' + colid).style.height = "290px";
		document.getElementById('estado_coluna_' + colid).value = "maximizada";
	}
	function fecharColuna(id){
		var colid = id;
		if(confirm('Deseja realmente excluir?')){
			document.getElementById('estado_coluna_' + colid).value = "excluida";
			document.getElementById('coluna_id_' + colid).style.display = "none";
		}
	}
	
	function DragAbleAtivo(id){
		var colid = id;
		document.getElementById('coluna_id_' + colid).dragableBox = true;
	}
	function DragAbleInativo(id){
		var colid = id;
		document.getElementById('coluna_id_' + colid).dragableBox = false;
	}
