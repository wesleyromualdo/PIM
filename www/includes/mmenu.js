...
function fixb(mnu) {
    ...
    if (menu[11]) {
        ...
        tw = lf - lfL;
        th = typ[2];
        if (_d.compatMode == "CSS1Compat") {} else {
            if (mac) {
                if (!_d.doctype) {
                    th = th + (m42);
                    tw = tw + m42
...
function dmenu(mnu) {
    ...
    if (menu[14]) {
        ...
        if (_d.layers) _d.write("<layer class=\"notprint\" z-index=1 id=menuback" + mnu + " top=" + (menu[1] - m14h) + " height=2 width=" + m14w + " left=0 bgcolor=" + hlp[1] + "></layer>");
        else _d.write("<div class=\"notprint\" id=menuback" + mnu + " style=\"position:absolute;top:" + (menu[1] - m14h) + "px;width:" + m14w + ";height:2px;\">&nbsp;</div>")
    }
    if (el) ns6c = 3;
    else ns6c = 2;
    ns6w = 0;
    ...
    if (ns4) {
        ...
        mt = "<layer class=\"notprint\" " + m18 + " z-index=29 visibility=hidden " + bgc + " id=" + mnu + " top=" + menu[1] + " left=" + menu[2] + " width=" + thw + ">"
        ...
        mt += "<div class=\"notprint\" tabindex=1 id=" + mnu + " style=\"" + iedf + scrof + ";z-index:19;visibility:hidden;" + brd + "position:absolute;background:" + m18 + hlp[1] + ";width:" + (menu[3] + ns6w) + "px;left:" + dmleft + "px;top:" + menu[1] + "px;\">"
        if (menu[19]) {
        ...
        if (ns4) {
            ...
            if (mbw > 0) {
                ...
                if (!menu[11]) {
                    ...
                    if (hlp[11] && mbw == 1) {
                        oc = "";
                        if (opra) oc = "_d.getElementById('el" + el + "').style.background='" + hlp[1] + "';_d.getElementById('el" + el + "').style.color='" + hlp[0] + "'";
    ...
    for (a = 1; a < menus; a++) {
        ...
        if (menu[21][0]) {
            ...
            if (menu[5].indexOf("top") != -1 || menu[5].indexOf("bottom") != -1 || menu[5].indexOf("middle") != -1) {
                ...
                mnp = gpos(mn);
                mnh = mnp[2];
                if (opra) mnh = mn.style.pixelHeight;
                nlp = wh - mnh;
...
function MScan() {
    ...
    if (opra) {
        ...
        if (ns4) {
            ...
            wh = window.innerHeight - 17
        } else {
            ww = _d.body.offsetWidth;
            if (!ww) ww = window.innerWidth - 15;
            ww--;
            wh = window.innerHeight;
        }
    }
    if (opra && (owh != wh || oww != ww)) {
        if (MLoaded > 1) {
            location.reload()
        }
        MLoaded++;
...
function Minit() {
    ...
    if (ns4) {
        ...
        oww = window.innerWidth - 16;
        owh = window.innerHeight - 17;
