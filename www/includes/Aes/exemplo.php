<?php 
    ...
    $pt = empty($_POST['pt']) ? 'pssst ... ?on?t tell anyøne!' : $_POST['pt'];
...
<form method="post">
    <table>
        ...
        <tr>
            <td>Plaintext:</td>
            <td><input type="text" name="pt" size="40" value="<?= simec_htmlspecialchars($pt) ?>"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="plain" size="40" value="<?= simec_htmlspecialchars($decr) ?>"></td>
        </tr>
    </table>
</form>
