...
var form_widget_amount_slider_handle = '../includes/JsLibrary/slider/images/slider_handle.gif';
...
function form_widget_amount_slider(targetElId,formTarget,width,min,max,onchangeAction)
{
	...
	addEvent( document.body  , 'onmousemove' , startMoveSlider );
	addEvent( document.body  , 'onmouseup' , stopMoveSlider );
