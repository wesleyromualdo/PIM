 ...
 *
 * @author  Felipe Tarchiani Cerívolo Chiavicatti
 * @since   07/04/2010
...
/*
 * Classe   Data
 * O obj Data possibilita operações aritiméticas (Adicionar dias) e lógicas em datas no formato Brasileiro (DD/MM/YYYY).
 *
 * @author  Felipe Tarchiani Cerívolo Chiavicatti
 * @since   07/04/2010
 * @exemple /simec/obras/modulos/principal/popUpInserirAditivo.inc
 ...
 * A classe possibilita a validação automática dos campos do formulário
 *
 ...
 * @link
 *
 * Lista de todos os validadores até o momento:
 * 		addValidaObrigatorio = function ( funcaoFlag ); - Para aplicação correta, leia a documentação do método;
 * 		addValidaTamanho = function ( tamanhoString, funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 * 		addValidaTamanhoMinimo = function ( tamanhoString, funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 * 		addValidaTamanhoMaximo = function ( tamanhoString, funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 * 		addValidaMascaraNumerica = function ( mascara, funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 * 		addValidaData = function ( funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 * 		addValidaMesAno = function ( funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 * 		addValidaExpressaoNumerica = function (operadorRelacional, numero, funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 * 		addValidaCnpj = function ( funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 * 		addValidaCpf = function ( funcaoFlag ) - Para aplicação correta, leia a documentação do método;
 *
 * 		addValidaExterno = function ( funcaoValida ) - Para aplicação correta, leia a documentação do método;
 *
 */
function ValidacaoAutomatica(){
	// Esta variável armazena os campos e suas configurações de validação
	var camposForm 		 = new Object();
	// Este índice armazena os atributos de função
	camposForm.param    = new Array();
	// Este índice armazena o atributo do item a ser validado
	camposForm.attr    = new Array();
	// Este índice armazena o valor (estuf, muncod) do atributo (id, name) a ser considerado na validação
	camposForm.valueAttr  = new Array();
	// Este índice armazena a label (Estado, Município) do campo (estuf, muncod) a ser considerado na validação
	camposForm.labelAttr  = new Array();
	// Este índice armazena a função de retorno booleano que dirá se a função de validação deve ser checada
	camposForm.funcaoFlag = new Array();
	// Este índice armazena o nome das funções de validação do campo
	camposForm.funcaoValidacao = new Array();

	// Mensagem Padrão
	var msgPadrao = new Object();
	// Flag de verificação de existencia de MSG
	...
	// Mensagem de validação de tamanho de campo
	...
	// Mensagem de validação de tamanho de campo mínimo
	...
	// Mensagem de validação de tamanho de campo máximo
	...
	// Mensagem de validação de campo numérico
	...
	// Mensagem de validação de campo data
	...
	// Mensagem de validação de campo Mês/Ano
	...
	// Mensagem de validação de expressão lógica
	...
	// Mensagem de validação de campo externo
	msgPadrao.validaExterno 	       	= new Object();
	msgPadrao.validaExterno.msg        	= 'Outras validações:';
	msgPadrao.validaExterno.attr       	= new Array();
	msgPadrao.validaExterno.msgUnitaria = false;

	/**
	 * function addCampo
	 * @description Adiciona um campo do formulário ao validador
	 * @param 		string attr 	 - Compreende ao nome do atributo (id, name, type) do campo que será usado para as validações
	 * @param 		string valueAttr - Compreende ao valor (estuf, muncod) do atributo (id, name, type) do campo que será usado para as validações
	 * @param 		string labelAttr - Compreende à  label do campo que será exibido nas mensagens de validação
	 * @return 		object this
	 ...
	 * @description Valida se o campo está vazio.
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação
	 * 										 será aplicada; caso retorne FALSE a validação NÃO será aplicada. Parâmetro obrigatório.
	 * @return 		object 	 	this
	 * @author 		Felipe Chiavicatti
	 * @since 		16/01/2015
	 */
	 ...
	 * @param 		integer		tamanhoString - Define o tamanho exato que a string deve conter. Parâmetro obrigatório.
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação será aplicada; caso retorne
	 * 										 FALSE a validação NÃO será aplicada. Parâmetro opcional.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
	 * @since 		14/04/2015
	 */
	 ...
	 * @description Valida o tamanho MÃ?NIMO de caracteres que o campo deve conter.
	 * @param 		integer		tamanhoString - Define o tamanho mínimo que a string deve conter. Parâmetro obrigatório.
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação será aplicada; caso retorne
	 * 										 FALSE a validação NÃO será aplicada. Parâmetro opcional.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
	 ...
	 * @description Valida o tamanho MÃ?XIMO de caracteres que o campo deve conter.
	 * @param 		integer		tamanhoString - Define o tamanho máximo que a string deve conter. Parâmetro obrigatório.
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação será aplicada; caso retorne
	 * 										 FALSE a validação NÃO será aplicada. Parâmetro opcional.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
	 ...
	 * @description Valida se o campo condiz com a máscara passada.
	 * @param 		string		mascara - Define a máscara que deve ser usada no preenchimento do campo (Ex.: ##/##/#### ou #####-### ou ########## etc)
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação será aplicada; caso retorne
	 * 										 FALSE a validação NÃO será aplicada. Parâmetro opcional.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
	...
	function validaMascaraNumerica( camposForm, indice ){
		...
		// Verifica se o valor do campo tem o mesmo tamanho da máscara
	 ...
	 * @description Valida se a data informada no campo é valida.
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação será aplicada; caso retorne
	 * 										 FALSE a validação NÃO será aplicada. Parâmetro opcional.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
...
//		var mascara   = camposForm.param[indice]['validaData'];
	 ...
	 * @description Valida se o Mês/Ano informado no campo é valido.
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação será aplicada; caso retorne
	 * 										 FALSE a validação NÃO será aplicada. Parâmetro opcional.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
...
//		var mascara   = camposForm.param[indice]['validaMesAno'];
	 ...
	 * @description Valida se o CNPJ informado no campo é valido.
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação será aplicada; caso retorne
	 * 										 FALSE a validação NÃO será aplicada. Parâmetro opcional.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
...
//			msgPadrao.validaMesAno.attr.push( (labelAttr ? labelAttr : attr) );
	 ...
	 * @description Valida se o CPF informado no campo é valido.
	 * @param 		function	funcaoFlag - Define uma função condicional de retorno booleano. Caso retorne TRUE, a validação será aplicada; caso retorne
	 * 										 FALSE a validação NÃO será aplicada. Parâmetro opcional.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
...
//	    	msgPadrao.validaCpf.attr.push( (labelAttr ? labelAttr : attr) );
	 ...
	 * @description Valida se a expressão nàÂºmerica informada aplicada ao valor do campo é valida ( Ex.: numeroCampo (10) operadorRelacional (>) numeroPassado (8)) <=> (10 > 8) )
	 * @param 		string		operadorRelacional - Define um operador relacional ( = | <> | > | >= | < | <= ) para ser aplicado na expressão.
	 * @param 		numeric		numero - Define um valor para ser aplicado na expressão. Pode ser passado o elemento do DOM para validações dinâmicas, ou seja:
	 ...
	 * @description Define um validador indicado pelo desenvolvedor, ou seja, que será construído pelo desenvolvedor.
	 * @param 		function	funcaoValida - Define uma função que será aplicada como um validador. Caso retorne TRUE, a validação passa; caso retorne 'STRING',
	 * 										   essa será usada como mensagem de erro do validador.
	 * @return 		object		this
	 * @author 		Felipe Chiavicatti
	 * @since 		16/01/2015
	 */
	...
	this.enviarFormulario = function ( idForm, hiddenCtrl, msgHiddenCtrl ){
...
//			sigDlgAlerta( trataMsgValidacao() );
		}else{
 ...
 * @param   string|object id - Deve conter o id ou objeto onde se está clicando a fim de montar a imagem "carregando"
 ...
 texto - No parametro texto pode ser passado o texto que aparecerá em tela. Não é obrigatório,
 aparecendo o texto "Carregando..." caso não passado.
 * @return  void
...
function divCarregado() {
    //var j = jQuery.noConflict();
    jQuery('#temporizador1').hide(300, function () {
        jQuery('#temporizador1').remove();
    });
}
...
function pegaRetornoAjax(tagIni, tagFim, html, somenteSeEncontrar) {
    ...
    if (somenteSeEncontrar == true && (iniReturn < 0 || fimReturn < 0)) {
        return false
    }
 ...
 *                    1º parametro: string com nome do formulário.
 *                    2º parametro: string ou array com os campos que deseja que seja validado.  Campos separados pelo caracter # se for passado como string.
 *                    3ºparametro: string ou array com os tipos de dados do parametro anterior. Campos separados pelo caracter # se for passado como string.
 *                    4º parametro: boleano indica se função irá subimeter o formulário ou não.
                ...
                if (formulario.elements[i].type == "textarea") {
                    ...
                    if (tiposDados[cont] == "numero") {
                        ...
                        if (!strValor) {
                            ...
                            existeErro = true;
                            erro[contErro] = "O CPF do campo " + formulario.elements[i].title + " não é válido.";
                            contErro++;
                        }
                    ...
                    if (tiposDados[cont] == "data") {
                        if (!strValor) {
                            ...
                            existeErro = true;
                            erro[contErro] = "O campo " + formulario.elements[i].title + " não é uma data.";
                            contErro++;
                        }
                    }
 ...
 * Abre a janela de interação do select_popup. Instruções no arquivo funcoes.inc
 * @param string nome
...
function combo_popup_buscar_codigo(nome, cod) {
    ...
    input.httpRequest.onreadystatechange = function () {
        combo_popup_recebe_buscar_codigo(input, nome);
    };
...
function validaInteiro(parametro) {
...
function validaDataMaior(dataIni, dataFin) {
    ...
    if ((dataIni.length != 0 && dataIni.length < 10) || (dataFin.length != 0 && dataFin.length < 10))
        return (true);
    else if ((dataIni.length != 0 && !validaData(dataIni)) || (dataFin.length != 0 && !validaData(dataFin)))
        return (true);
...
function validarCpfCnpj(e) {
    if (e.value.length != 14 && e.value.length != 18) {
        alert('O CPF ou CNPJ informado não ï¿½ vï¿½lido!');
        return false;
    }
...
/**
 * Função que envia uma requisições em ajax para a própria página
...
/*
 * Função similar com a in_array() do php
 * */
...
/**
 * Faz a mudança de focus automatica de um elemento para o outro após o usuario digitar um valor
 *
 * @param string nameCurrentElement atributo "name" do elemento atual que perderá o foco
 * @param string nameNextElement atributo "name" do elemento que receberá o foco
 * @returns VOID
 */
...
function envia_email( cpf ){
	if (validar_cpf(cpf)){
		...
		alert('Implementar envio de E-mail');
	}
}
