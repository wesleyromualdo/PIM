                        ...
                        <div class="middle-box text-center animated fadeInDown">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="glyphicon glyphicon-lock"></span> ERRO 403 (Acesso Negado)
                                </div>
                                <div class="panel-body">
                                    <h1 class="font-bold"></h1>
                                    <div class="error-desc">
                                        <div class="error-desc">
                                            <p>Você não tem acesso à página que está procurando,
                                                clique em voltar para retornar à página anterior.</p>
