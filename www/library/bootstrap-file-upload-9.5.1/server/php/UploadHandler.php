...
//        var_dump($_SESSION['BOOTSTRAP_FILE_UPLOAD']['dir']);
//        var_dump(file_exists($_SESSION['BOOTSTRAP_FILE_UPLOAD']['dir']));
//        exit;

        $this->options = array(
            'script_url' => $this->get_full_url().'/',
//            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/arquivos/tmp/',
//            'upload_url' => $this->get_full_url().'/arquivos/tmp/',
            'upload_dir' => $_SESSION['BOOTSTRAP_FILE_UPLOAD']['dir'],
            'upload_url' => $_SESSION['BOOTSTRAP_FILE_UPLOAD']['url'],
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
