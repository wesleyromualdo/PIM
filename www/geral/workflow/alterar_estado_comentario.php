...
function validaFormulario(){
        var resultado = false;
        if(document.getElementById('cmddsc').value == ''){
            alert('Insira um comentário.');
           document.getElementById('cmddsc').focus();
        }else{
            resultado = true;
        }
        return resultado;
...
<html>
	...
	<body style="font-size:7pt;" leftmargin="0" topmargin="0" bottommargin="0" marginwidth="0" marginheight="0" bgcolor="#ffffff">
		<form method="post" action="http://<?php echo $_SERVER['HTTP_HOST'] ?>/geral/workflow/alterar_estado.php" onSubmit="return validaFormulario();"  name="combo_alterar_estado_comentario">
			...
			<table width="100%" align="center" border="0" cellspacing="1" cellpadding="3" align="center" style="border: 1px Solid Silver; background-color:#f5f5f5; font-size: 8pt;">
				...
				<tr>
					<td align="right" class="subtitulodireita" style="background-color: #dfdfdf;">
                        <?=($aedid == 4580 ?"Justificativa":"Comentário" )?>
