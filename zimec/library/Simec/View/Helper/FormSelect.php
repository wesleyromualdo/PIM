 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Simec_View_Helper_FormSelect extends Simec_View_Helper_FormElement
{
    public function formSelect($name, $label = null, $value = null, $options = null, $attribs = null, $config = array())
    {
