...
class Simec_View_Helper_Cep extends Simec_View_Helper_Element
{
    public function cep($name, $label = null, $value = null, $attribs = array(), $config = array())
    {
        ...
        $class = isset($attribs['class']) ? 'form-control cep ' .  $attribs['class'] : 'form-control cep';

        $config['cep'] = 'cep';
        $config['icon'] = $config['icon'] ? $config['icon'] : 'fa fa-map-marker';
