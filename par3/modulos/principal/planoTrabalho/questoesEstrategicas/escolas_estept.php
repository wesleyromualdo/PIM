<?php
$controllerQuestoes = new Par3_Controller_QuestoEsestrategicasEscolasEstEPT();
...
if ($qrpid && $inuid) {
    global $db;
    $strSQL = $controllerQuestoes->listaEscolasEstEPT($_REQUEST, true);
...
<form method="post" name="formularioEscolas" id="formularioEscolas" class="form form-horizontal">
    ...
    <input type="hidden" name="req" value="salvarEscolaEstEPT"/>
    <div class="ibox">
