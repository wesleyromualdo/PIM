<?php
$controllerQuestoes = new Par3_Controller_QuestoEsestrategicasEscolasEPT();
...
if ($qrpid && $inuid) {
    global $db;
    $strSQL = $controllerQuestoes->listaEscolasEPT($_REQUEST, true);
...
<form method="post" name="formularioEscolas" id="formularioEscolas" class="form form-horizontal">
    ...
    <input type="hidden" name="req" value="salvarEscolaEPT"/>
    <div class="ibox">
