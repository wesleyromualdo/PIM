     ...
     <div class="ibox">
                ...
                <div class="ibox">
                    <div class="ibox-title">
                        <h3 class="pull-left" style="margin-bottom: 10px">Dados dos Veículos</h3>
                    </div>
                    <div class="ibox-content" style="display: block">
                        <div class="row">
                            <div class="col-md-12">
                                <form method="POST" id="formVeiculo" action="" class="form form-horizontal" enctype="multipart/form-data">
                                    <?php if($disabled == '') { ?>
                                        <?php $controllerVeiculo->formVeiculo($_REQUEST); ?>
                                    <?php } ?>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="ibox-content">
                        <center><h4 class="listagemVeiculos">Listagem de Veículos</h4></center>
                        <?php $_REQUEST['vcopossuirenavam'] = 't'; ?>
                        <div id="listagemAutomoveis">
                            <?php $controllerVeiculo->listarVeiculos($_REQUEST); ?>
                        </div>
                    </div>
                    <div class="ibox-content">
                        <center><h4 class="listagemVeiculos">Listagem de Embarcações</h4></center>
                        <?php $_REQUEST['vcopossuirenavam'] = 'f'; ?>
                        <div id="listagemEmbarcacoes">
                            <?php $controllerVeiculo->listarVeiculos($_REQUEST); ?>
                        </div>
                    </div>
