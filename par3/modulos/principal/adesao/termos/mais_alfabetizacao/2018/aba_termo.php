<div class="panel-body">
    ...
    if (
        ...
        <div style="text-align: center;margin-top: 20px;">
            <?php if ($mostrar && (!$vencido)) { ?>
                ...
                <button onclick='javascript:confirmaAdesaoAlfabetizacao( "S", "/par3/par3.php?modulo=principal/adesao/termo&acao=A&aceite=S&inuid=<?php echo $_GET['inuid'] ?>&prgid=<?php echo $_GET['prgid'] ?>&adpano_ciclo=<?php echo $adpano_ciclo; ?>")'
                        class="btn btn-primary">Sim
                </button>

                <button onclick='javascript:confirmaAdesaoAlfabetizacao( "N", "/par3/par3.php?modulo=principal/adesao/termo&acao=A&aceite=N&inuid=<?php echo $_GET['inuid'] ?>&prgid=<?php echo $_GET['prgid'] ?>&adpano_ciclo=<?php echo $adpano_ciclo; ?>")'
                        class="btn btn-danger">Não
                </button>
    ...
    <?php } elseif ($aceite['adpresposta'] == "S" && !$termoincompleto) { ?>
        ...
        <div style="text-align: center;margin-top: 20px;">
            <a href="/par3/par3.php?modulo=principal/adesao/termo&acao=A&itrid=<?php echo $itrid ?>&requisicao=pdf_termo&inuid=<?php echo $_GET['inuid'] ?>&prgid=<?php echo $_GET['prgid'] ?>"
               target="_blanck">
    ...
    <?php } else if (!$termoincompleto) {
        if (($result['adpresposta'] == 'N') && ($esdid == WF_ESDID_TERMONAOACEITO_MAISALFABETIZACAO)) {
            ?>
            <div style="margin-top: 5px;" class="text-right">
            ...
            <div style="text-align: center;margin-top: 20px;">
                ...
                <button onclick='javascript:confirmaAdesaoAlfabetizacao( "C", "/par3/par3.php?modulo=principal/adesao/termo&acao=A&aceite=C&inuid=<?php echo $_GET['inuid'] ?>&prgid=<?php echo $_GET['prgid'] ?>&adpano_ciclo=<?php echo $adpano_ciclo; ?>")'
