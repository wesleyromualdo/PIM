...
<div class="wrapper wrapper-content">
    ...
    <div class="ibox-content">
        ...
        <div class="row">
             {!! Form::open(array('route' => 'usuarioglobal.consultarUsuarios','method'=>'POST', 'class' => 'form-horizontal')) !!}
                    @include('seguranca::usuarioglobal.form-pesquisa', ['errors' => $errors])
             {!! Form::close() !!}            
        </div>
        ...
        $(function () {                        
            ...
            var estuf =  $('#unidadeFederativa').val();
              ...
              $('#btn-pesquisar-usuario').on('click', function () {              
                ...
                "serverSide": true,
                "ajax": {
                    url: "{{ route('usuarioglobal.getList') }}",
