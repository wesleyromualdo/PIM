@extends('layouts.app')
@section('title', 'Listar responsabilidades')
@section('content')

<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Gerenciar Usuário Responsabilidade</h2>
        <ol class="breadcrumb">
            <li><a href="#">Sistema</a></li>
            <li>Tabelas de Apoio</li>
            <li class="active"><strong>Gerenciar Usuário Responsabilidade</strong></li>
        </ol>
    </div>
</div>
@if (!$objContainer->tiposResponsabilidades)
    <div class="form-group">
        ...
        <div class="col-sm-4 col-sm-offset-5">
            <a href="{{ route($objContainer->prefixo.'.usuario.edit', $objContainer->usucpf) }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> Voltar</a>
        </div>
    </div>
@else
...
//            $('#tb_responsabilidades').on( 'page.dt', function () {
