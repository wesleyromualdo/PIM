    ...
    <div class="form-group">
        <label class="col-md-2 control-label text-right p-xxs">Município:</label>
         <div class="col-md-10">
             {!! Form::select('municipio', $municpiosPorUnidade, $usuario->muncod, ['class' => 'form-control chosen-select', 'placeholder' => 'Selecione...', 'id' => 'municipio'] )!!}
        </div>
    </div>  
    ...
    <div class="form-group">
        <div class="col-sm-4 col-sm-offset-2">
            <a href="{{ route('usuarioglobal.index') }}" class="btn btn-default"><i class="fa fa-arrow-left"></i> Voltar</a>
            <button type="button" class="btn btn-salvar-modal btn-md  btn-primary" id="salvar-usuario"><i class="fa fa-save"></i> Salvar Usuário</button>
        </div>
    </div>
