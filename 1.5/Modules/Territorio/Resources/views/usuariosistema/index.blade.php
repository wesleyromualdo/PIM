@php
    //$usrSisController = new UsuarioSistemaController;
    //$usrSisController->index();
@endphp
@inject('usrSisController', 'Modules\Seguranca\Http\Controllers\UsuarioSistemaController')
    ...
    function GeraTabelaSistemas () {
        var parametros  = JSON.parse('{!! json_encode($objContainer) !!}');
            ...
            dataTable_usuarioSistema =  $('#tb_usuariosistema').DataTable({
                ...
                "paging":false,
                "ajax": {
                    url: "{{ route('usuariosistema.callMethod') }}",
                    method: 'POST',
                    data:{ action: 'getList',
